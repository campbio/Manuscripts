...
cat("RMSE is : \n", sqrt(mean( (df.conp$tru.conp[ df.conp$call == "hg19" ] - df.conp$est.conp[ df.conp$call == "hg19" ])^2 ) )   )  
...
cat("RMSE is : \n", sqrt(mean( (df.conp$tru.conp[ df.conp$call == "mm10" ] - df.conp$est.conp[ df.conp$call == "mm10" ])^2 ) )   )  
...
cat( "Correlation between 1) the correlation of mouse-specific genes in human cells and 2) the distribution of those genes' expression in an average mouse cell is: \n ", cor( mmGeneProp$real.averageExp.cpm, mmGeneProp$prop.inContaminatedTranscripts) )    
cat( "Correlation between 1) the proportion of human-specific genes in mouse cells and 2) the distribution of those genes' expression in an average human cell is: \n ", cor( hgGeneProp$real.averageExp.cpm, hgGeneProp$prop.inContaminatedTranscripts) )  
