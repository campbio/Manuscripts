...
#   sce8_qc  (dataset) is a mixture of mRNA from "H2228", "H1975" and "HCC827" 3 cell lines in different proportions. 
...
get.sce8_qc= counts.n.z( sce = sce8_qc)
saveRDS(get.sce8_qc, "get.sce8_qc.rds") 
...
set.seed(12345)
dcon = decontX( counts = get.sce8_qc$counts , z = get.sce8_qc$z) 
saveRDS( dcon, "dcon.sce8_qc.rds" )  
