...
setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana/sinCell3/")
...
setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana/sinCell5/")
...
setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana")
...
setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana/mixRNA/sce2_qc") 
dcon.mixRNA.celseq2 = readRDS("dcon.sce2_qc.rds") 
get.sce2_qc = readRDS("get.sce2_qc.rds")



setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana/mixRNA/sce8_qc") 
...
setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana")
pdf("Fig6_bench.pdf", width = 8.5, height = 8)  
grid.arrange(pg.vio, pg.pca, ncol = 1, top = "Figure 6", heights = c(3.5, 5)  )
dev.off()
...
setwd("/restricted/projectnb/camplab/home/syyang/contamination/contamination-output/cellBenchData-ana")
pdf("Sup_Fig_7.pdf", width = 8.5, height = 8)
...
# two way anova test 
 test.anova = aov(DecontX_Contamination ~ doublet + datasetName, data = binded.dt) 
 summary(test.anova) 



# mixed effect liner regression 
 library(lme4)
binded.dt = binded.dcon
binded.dt$doublet= factor(binded.dcon$doublet, levels = c("SNG", "DBL") ) 
mlm = lmer(DecontX_Contamination ~ doublet + (1 | datasetName), data = binded.dcon)
summary( mlm)
